...
plot(CDtot(:,1), CL(:,1), 'k', 'LineWidth', 2) %left polar
scatter(CDtot(idx_max(1),1), CL(idx_max(1),1), 80,  "o",'LineWidth', 1.5, MarkerEdgeColor = "#D95319")
...
plot(CDtot(:,2), CL(:,2), 'k', 'LineWidth', 2) %right polar
scatter(CDtot(idx_max(2),2), CL(idx_max(2),2), 80, "o",'LineWidth', 1.5, MarkerEdgeColor = "#D95319")
...
scatter(CDtot(idx_max_endurance(1),1), CL(idx_max_endurance(1),1), 80, 'o', 'LineWidth', 1.5, MarkerEdgeColor = "#D95319")
scatter(CDtot(idx_max_endurance(2),2), CL(idx_max_endurance(2),2), 80, 'o','LineWidth', 1.5, MarkerEdgeColor = "#D95319")
text(0.145, CL(idx_max_endurance(1),1)+offset, sprintf('L/D = %.1f', LD_endurance(1)), 'FontName', 'Abolition', 'FontSize', fontSize_text, Color='k')  
text(0.145, CL(idx_max_endurance(1),1)-offset, sprintf('L/D = %.1f', LD_endurance(2)), 'FontName', 'Abolition', 'FontSize', fontSize_text, Color='k') 
...
text(0.13, 0.7, text2, 'FontName', 'Abolition', 'FontSize', fontSize_subtitles)

text1 = sprintf('Clean Drag Index = 0\n{C_D}_0 = %.3f\ne = %.2f\nA = %.2f', CD0(1), e(1), A(1)); %for clean conditions

text(0.01, 0.7, text1, 'FontName', 'Abolition', 'FontSize', fontSize_subtitles)
...
idx_max_speed(1) = 19;
scatter(CDtot(idx_max_speed(1),1), CL(idx_max_speed(1),1), 80, 'o', 'LineWidth', 1.5, MarkerEdgeColor = "#D95319");
scatter(CDtot(idx_max_speed(1),2), CL(idx_max_speed(1),2), 80, 'o', 'LineWidth', 1.5, MarkerEdgeColor = "#D95319");
LD_max_speed(1) = CL(idx_max_speed(1),1) / CDtot(idx_max_speed(1),1); %calculate LD at min. cruise condition
LD_max_speed(2) = CL(idx_max_speed(1),2) / CDtot(idx_max_speed(1),2);
