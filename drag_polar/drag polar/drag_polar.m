...
% text(0.051, 0.65, 'T-6B Best L/D ','FontSize', 14, 'FontName', 'Calibri', 'Rotation', 63, Color='k')
...
% text(0.17, CL(idx_max(1),1)+0.015, 'Best Range', 'FontName', 'Calibri','FontSize', 14, Color='k')
% text(0.08, CL(idx_max(1),1)+0.015, sprintf('L/D = %.1f', LD_max(1)), 'FontName', 'Calibri', 'FontSize', 14, Color='k')  
% text(0.08, CL(idx_max(1),1)-0.015, sprintf('L/D = %.1f', LD_max(2)), 'FontName', 'Calibri','FontSize', 14,  Color='k') 
% 
% %plot max endurance line 
% yline(CL(idx_max_endurance(1),1), 'r--', 'LineWidth', 2)
% text(0.17, CL(idx_max_endurance(1),1)+0.015, 'Max Endurance', 'FontName', 'Calibri','FontSize', 14, Color='k')
...
% text(0.145, CL(idx_max_endurance(1),1)+0.015, sprintf('L/D = %.1f', LD_endurance(1)), 'FontName', 'Calibri', 'FontSize', 14, Color='k')  
% text(0.145, CL(idx_max_endurance(1),1)-0.015, sprintf('L/D = %.1f', LD_endurance(2)), 'FontName', 'Calibri', 'FontSize', 14, Color='k') 
% 
...
% 
% text(0.13, 0.85, text2, 'FontName', 'Calibri', 'FontSize', 14)
% 
% text1 = sprintf('Clean Drag Index = 0\n{C_D}_0 = %.3f\ne = %.2f\nA = %.2f', CD0(1), e(1), A(1)); %for clean conditions
% 
% text(0.01, 0.85, text1, 'FontName', 'Calibri', 'FontSize', 14)
% 
...
% text(0.17, CL_max_speed(1)+0.015, 'Min. Cruise', 'FontName', 'Calibri','FontSize', 14, Color='k')
% idx_max_speed(1) = 19;
...
% text(0.08, CL(idx_max_speed(1),1)+0.015, sprintf('L/D = %.1f', LD_max_speed(1)), 'FontName', 'Calibri', 'FontSize', 14, Color='k')
% text(0.08, CL(idx_max_speed(1),2)-0.015, sprintf('L/D = %.1f', LD_max_speed(2)), 'FontName', 'Calibri', 'FontSize', 14, Color='k')
% 
% %plot formatting
% 
...
text(0.17, CL(idx_max(1),1)+offset, 'Best Range', 'FontName', 'Calibri','FontSize', fontSize_text, Color='k')
...
text(0.17, CL(idx_max_endurance(1),1)+offset, 'Max Endurance', 'FontName', 'Calibri','FontSize', fontSize_text, Color='k')
...
text(0.12, CL(idx_max_endurance(1),1)+offset, sprintf('L/D = %.1f', LD_endurance(1)), 'FontName', 'Calibri', 'FontSize', fontSize_text, Color='k')  
text(0.12, CL(idx_max_endurance(1),1)-offset, sprintf('L/D = %.1f', LD_endurance(2)), 'FontName', 'Calibri', 'FontSize', fontSize_text, Color='k') 
...
% text(0.067, 0.766, 'A-37 Best L/D', 'FontSize', 14,'FontName', 'Calibri','Rotation', 66, Color='k')
...
% text(0.16, CL(idx_range(3),3)+0.015, 'Best Range','FontSize', 12, 'FontName', 'Calibri', Color='k')
% text(0.115, CL(idx_range(3),3)+0.015, sprintf('L/D = %.1f', LD_range(3)),'FontSize', 12, 'FontName', 'Calibri', Color='k')   
% text(0.115, CL(idx_range(3),3)-0.015, sprintf('L/D = %.1f', LD_range(4)), 'FontSize', 12,'FontName', 'Calibri', Color='k') 
% 
% %plot max endurance line 
% yline(CL(idx_max_endurance(3),3), 'r--')
% text(0.16, CL(idx_max_endurance(3),3)+0.015, 'Max Endurance','FontSize', 12, 'FontName', 'Calibri', Color='k')
...
% text(0.11, CL(idx_max_endurance(3),3)+0.015, sprintf('L/D = %.1f', LD_endurance(3)),'FontSize', 12, 'FontName', 'Calibri', Color='k')  
% text(0.11, CL(idx_max_endurance(3),3)-0.015, sprintf('L/D = %.1f', LD_endurance(4)), 'FontSize', 12,'FontName', 'Calibri', Color='k') 
% 
% text(0.105, 0.766, 'L-39 Best L/D ','FontSize', 14, 'FontName', 'Calibri','Rotation', 64.5, Color='k')
% 
% %labeling the polars
% text3 = sprintf('Highest Drag Index = 1\n{C_D}_0 = %.3f\ne = %.2f\nA = %.2f', CD0(4), e(4), A(4)); %for highet drag case
% 
% text(0.127, 0.9, text3, 'FontName', 'Calibri', 'FontSize', 14)
% 
% text4 = sprintf('Clean Drag Index = 0\n{C_D}_0 = %.3f\ne = %.2f\nA = %.2f', CD0(3), e(3), A(3)); %for clean conditions
% 
% text(0.035, 0.9, text4, 'FontName', 'Calibri', 'FontSize', 14)
% 
% %plot formatting
% 
% xlim([0 0.2]);           % X-axis limit from 0 to 0.2
...
% 
% % Label axes
% xlabel('C_D', 'FontName', 'Calibri');           % Label for X-axis
% ylabel('C_L', 'FontName', 'Calibri', Rotation= 0);           % Label for Y-axis
% 
% % Set font size and other formatting adjustments to match style
% ax.FontSize = 14;        % Adjust font size
% ax.LineWidth = 1;        % Set axis line width
