...
CL(:,1) = linspace(0, 1.5); 
CD0(1) = 0.0182; % also just a guess 
...
figure 
hold on 
plot(x(:,1), y(:,1), 'b') %max L/D line for left polar
text(0.06, 0.766, 'T-6B Best L/D ','FontSize', 14, 'FontName', 'Abolition', 'Rotation', 63, Color='k')
...
plot(x(:,2), y(:,2), "Color", '#77AC30') %max L/D lien for right polar
...
text(0.075, 0.74, 'OV-10D Best L/D ','FontSize', 14, 'Rotation', 57, Color='k')
...
CL_max_speed(1) = WS/q;
yline(CL_max_speed(1), 'r--')
text(0.17, CL_max_speed(1)+0.015, 'Min. Cruise', 'FontName', 'Abolition','FontSize', 12, Color='k')
idx_max_speed(1) = 19;
...
text(0.08, CL(idx_max_speed(1),1)+0.015, sprintf('L/D = %.1f', LD_max_speed(1)), 'FontName', 'Abolition', 'FontSize', 12, Color='k')
text(0.08, CL(idx_max_speed(1),2)-0.015, sprintf('L/D = %.1f', LD_max_speed(2)), 'FontName', 'Abolition', 'FontSize', 12, Color='k')
